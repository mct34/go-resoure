...
// This file contains the implementation(执行) of Go's map type.
//
...
type bmap struct {
	...
	//tophash通常包含该bucket中每个键的哈希值的顶部字节。
	//如果tophash[0]＜minTopHash，则tophash[0]为bucket疏散状态。
